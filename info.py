...
BOT_TOKEN = environ.get['BOT_TOKEN', '6419517188:AAHTQck00914Wib2u_C6nU07ee64pQ9kPn4']
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1023220024').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002136614235').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://pykoloy:pykoloy@cluster0.oalxlyv.mongodb.net/?retryWrites=true&w=majority")
...
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'adlinkshort.xyz')
SHORTLINK_API = environ.get('SHORTLINK_API', 'e4d21f1aa39cb5c4bab8a3a2289e1cd07d3fcfac')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002042466254'))
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002071959242')).split()]
